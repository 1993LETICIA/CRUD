...
<html>
    ...
    <body>
        ...
        <div id="container" class="container-fluid">
            <h3 class="page-header">${not empty company ? 'Atualizar' : 'Cadastrar'} Empresa</h3>
            ...
            <form action="${pageContext.request.contextPath}/company/${action}" method="POST">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="name" name="name" 
                               ...
                               oninput="setCustomValidity('')" value="${company.getName()}"/>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="role" name="role" 
                               ...
                               oninput="setCustomValidity('')" value="${company.getRole()}"/>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control" id="start" name="start" 
                               ...
                               oninput="setCustomValidity('')" value="${company.getStart()}"/>
                    </div>
                    
                    <div class="form-group col-md-4">
                        <label for="end">Data saida</label>
                        <input type="date" class="form-control" id="end" name="end" 
                               autofocus="autofocus" placeholder="Data de saida" 
                               oninvalid="this.setCustomValidity('Por favor, informe a data de saida.')"
                               oninput="setCustomValidity('')" value="${company.getEnd()}"/>
                    </div>
                ...
                <div id="actions" class="row pull-right">
                    <div class="col-md-12">
                        ...
                        <button type="submit" class="btn btn-primary">${not empty company ? 'Atulizar' : 'Cadastrar'} Empresa</button>
                    </div>
                </div>
